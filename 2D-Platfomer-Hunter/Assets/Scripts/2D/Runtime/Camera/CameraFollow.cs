...
public class CameraFollow : MonoBehaviour
{
    ...
    public Raycaster MainTarget { get { return m_MainTarget; } }
    ...
    private void Start()
    {
        m_FocusArea = new FocusArea(m_MainTarget.Collider.bounds, m_FocusAreaSize);
        m_TargetPositionX = m_MainTarget.transform.position.x;
    }

    private void LateUpdate()
    {
        m_FocusArea.Update(m_MainTarget.Collider.bounds);

        m_TargetVelocityX = m_MainTarget.transform.position.x - m_TargetPositionX;
